    ...
    return (
        <div className="kordleContents">
            <dialog open={isOpenNotice}>
                ...
                <p>확정된 글자를 입력(초록칸/숫자야구에임의 strike) 하고 </p> 
                <p>포함되지만 칸이 다른 글자(노란칸/숫자야구게임의 ball)를 입력하고 </p> 
                <p>사용되지 않는 글자(회색칸/숫자야구게임의 out)을 입력하여 </p> 
                <p>남은 자/모를 확인하며 단어조합에 약간이나마 도움을 주기위해 작성된 페이지입니다.</p> 


                <p>혹 사용간 불편한 사항이나 건의사항은 아래 메일 또는 카카오톡 오픈채팅을 통해 전달주시면 감사합니다.</p>
                <p>E-Mail : nuckly60@gmail.com </p>
                <p>KAKAO TALK :  <a href="https://open.kakao.com/o/gdYCzqOg"  target='_blank'>카카오톡</a></p>
                <br />
                <p>그럼 즐거운 게임되세요! </p>
                <p>감사합니다 </p>
